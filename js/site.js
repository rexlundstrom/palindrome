...
const displayResults = (array) => {
  ...
  if (array[2] == true) {
    ...
    document.getElementById(
      "success-message"
    ).textContent = `"${array[0]}" written backwards is ${array[1]}! You've got yourself a palindrome.`;
    ...
    document.getElementById(
      "failure-message"
    ).textContent = `${array[0]} written backwards is ${array[1]} which is not a palindrome.`;
